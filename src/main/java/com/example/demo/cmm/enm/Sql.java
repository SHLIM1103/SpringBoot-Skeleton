...
public enum Sql {
    CREATE_MANAGERS, CREATE_SUBJECTS, CREATE_STUDENTS, CREATE_TEACHERS, CREATE_GRADES,
    CREATE_ARTICLES, CREATE_REPLIES, TABLE_COUNT, TRUNCATE, TOTAL_COUNT, DROP_TABLE;
    @Override
